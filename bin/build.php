...
$interfaces = [];
$filename = __DIR__.'/../vendor/php-fig/fig-standards/proposed/http-request-handler/http-request-handler.md';
...
while ($event = $walker->next()) {
    ...
    $code = str_replace('Psr\Http\RequestHandler', 'Interop\Http\RequestHandler', $code);
